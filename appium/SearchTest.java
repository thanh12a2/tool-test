 ...
 * ===================================================================
 * Tham chiếu: SystemTest.xlsx → Sheet A-F-06 Search
...
public class SearchTest extends BaseAppiumTest {
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC01: Tìm kiếm theo tên bác sĩ hợp lệ
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC02: Tìm kiếm theo chuyên khoa
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC03: Tìm kiếm không có kết quả
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC04: Tìm kiếm với chuỗi rỗng
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC06: Tìm kiếm với ký tự đặc biệt / XSS
    ...
    // -----------------------------------------------------------------
    // A-F-06-TC07: Kiểm tra giao diện SearchActivity đầy đủ
