...
// ------------------------------------------------------------
// A-F-04-TC-03 | Chức năng: Nghiệp vụ - response xác nhận đã huỷ
...
// ------------------------------------------------------------
pm.test("A-F-04-TC-03 - Response xác nhận huỷ thành công", function () {
...
// ------------------------------------------------------------
// A-F-04-TC-04 | Chức năng: Idempotency - gọi DELETE lại lần 2
...
// ------------------------------------------------------------
pm.test("A-F-04-TC-04 - DELETE idempotent (không phá vỡ khi gọi lại)", function () {
...
// ------------------------------------------------------------
// A-F-04-TC-05| Chức năng: Error handling & bảo mật
...
// ------------------------------------------------------------
pm.test("A-F-04-TC-05 - Không rò rỉ thông tin nhạy cảm hoặc dữ liệu người khác", function () {
