...
// 5 test case: A-F-07-TC01 -> A-F-07-TC05
...
// ------------------------------------------------------------
// A-F-07-TC01: Status code = 200 và response có cấu trúc cơ bản
// (Kỳ vọng: PASS)
// ------------------------------------------------------------
pm.test("A-F-07-TC01 - Xem hồ sơ khám bệnh: trả về 200 và có data hợp lệ", function () {
...
// ------------------------------------------------------------
// A-F-07-TC02: Thông tin cuộc hẹn (appointment) đầy đủ
// (Kỳ vọng: PASS)
// ------------------------------------------------------------
pm.test("A-F-07-TC02 - Hồ sơ chứa thông tin cuộc hẹn: id, bệnh nhân, ngày khám, trạng thái", function () {
...
// ------------------------------------------------------------
// A-F-07-TC03: Thông tin bác sĩ và chuyên khoa
// (Kỳ vọng: PASS)
// ------------------------------------------------------------
pm.test("A-F-07-TC03 - Hồ sơ chứa thông tin bác sĩ và chuyên khoa khám", function () {
...
// ------------------------------------------------------------
// A-F-07-TC04: Nội dung chẩn đoán (reason, description, status_before/after)
...
// ------------------------------------------------------------
pm.test("A-F-07-TC04 - Nội dung chẩn đoán phải đầy đủ và hợp lệ (không chứa HTML entity lỗi)", function () {
...
// ------------------------------------------------------------
// A-F-07-TC05: Thời gian tạo/cập nhật hợp lệ và create_at <= update_at
// (Kỳ vọng: PASS với dữ liệu hiện tại, nhưng có thể FAIL nếu backend
//  ghi sai thứ tự create_at / update_at - đây là guard test)
// ------------------------------------------------------------
pm.test("A-F-07-TC05 - Thời gian tạo và cập nhật hồ sơ hợp lệ (create_at <= update_at)", function () {
