// ============================================================
// A-F-12-TC01 - Hiển thị nhiệt độ thời tiết trên màn Home
// Kiểm tra response từ OpenWeatherMap trả về đầy đủ thông tin
// nhiệt độ và tên thành phố để hiển thị trên Home.
// ============================================================

pm.test("A-F-12-TC01 - Màn Home hiển thị nhiệt độ thời tiết: response có name và temp hợp lệ", function () {
