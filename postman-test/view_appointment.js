...
// Gồm 2 test case: A-F-04-TC01 và A-F-04-TC02
...
pm.test("A-F-04-TC01 - Xem lịch sử lịch hẹn: hiển thị đầy đủ trạng thái, ngày giờ, khoa khám, họ tên, SĐT, lý do khám", function () {
...
pm.test("A-F-04-TC02 - Xem lịch sử khi chưa có lịch hẹn: hiển thị trạng thái trống 'Chưa có lịch hẹn nào'", function () {
    pm.expect(pm.response.code, "Status code").to.eql(200);
    pm.expect(response, "response").to.have.property("data");
    pm.expect(response.data, "data").to.be.an("array");
