// ============================================================
// A-F-07 - search speciality
// 6 test cases, all run real assertions in ONE Send click.
// TC02 uses the original request. TC01/TC03..TC06 use pm.sendRequest.
// ============================================================
...
pm.test("A-F-07-TC01 - Tìm kiếm theo chuyên khoa: hiển thị chuyên khoa", function () {
...
pm.test("A-F-07-TC02 - Tìm kiếm không có kết quả: trạng thái trống", function (done) {
...
// ---------- TC03: chuỗi rỗng ----------
pm.test("A-F-07-TC03 - Tìm kiếm với chuỗi rỗng: trả về danh sách", function (done) {
...
// ---------- TC04: một ký tự ----------
pm.test("A-F-07-TC04 - Tìm kiếm với một ký tự: lọc theo ký tự hoặc báo cần nhập thêm", function (done) {
...
// ---------- TC05: XSS payload ----------
pm.test("A-F-07-TC05 - Tìm kiếm ký tự đặc biệt/XSS: input được làm sạch, không phản hồi XSS", function (done) {
